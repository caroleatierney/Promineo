...
// class Person {
//     constructor(newName, persAge, persHairColor) {
//         this.name = newName;
//         this.age = persAge;
//         this.hairColor = persHairColor;
//     }
//     introduce() {
...
//     constructor(name, age, hairColor, courseName) {
//         super(name, age, hairColor);
//         this.courseName = courseName;
//     }
//     introduceSelf() {
//         console.log(`My name is ${this.name}, and I will be teaching your ${this.courseName} class.`);
//         console.log(`I am ${this.age} years old and my hair is ${this.hairColor} class.`);
//     }
// }
// let teacher = new Teacher('Ms. Angle', 45, 'blond', 'Trigonometry');
